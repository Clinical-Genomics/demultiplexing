#!/bin/bash
#SBATCH -c 18
#SBATCH -p dragen # REMOVE AFTER TESTING
##SBATCH -p gpu # REMOVE AFTER TESTING
#SBATCH --qos=low
#SBATCH --time=600
...
log "singularity exec --bind /home/proj/stage/flowcells/novaseq:/home/proj/stage/flowcells/novaseq/runs,/home/proj/stage/flowcells/novaseq/demux,/home/proj/stage/flowcells/novaseq/"$SLURM_JOB_ID":/run/user/$(id -u) /home/proj/development/demux-on-hasta/novaseq/container/bcl2fastq_v2-20-0.sif bcl2fastq --loading-threads 3 --processing-threads 15 --writing-threads 3 --runfolder-dir ${RUN_DIR} --output-dir ${DEMUX_DIR}/${UNALIGNED_DIR} --use-bases-mask ${BASEMASK} --sample-sheet ${RUN_DIR}/SampleSheet.csv --barcode-mismatches 1"
