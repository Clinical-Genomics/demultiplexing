#!/bin/bash
#   usage:
#      getfastq2.bash <absloute-unaligned-base> <project_name>
...
PLOG=$(ls ${UNALIGNBASE} | grep projectlog | tail -n 1)
...
echo ${UNALIGNBASE}Unaligned/${PROJ}/${vars}
echo [${NOW}] [${RUN}] ${UNALIGNBASE}Unaligned/${PROJ}/${vars} >> ${PROJECTLOG}
BARCODE=$(ls ${UNALIGNBASE}Unaligned/${PROJ}/${vars} | grep _L001_R1_001.fastq.gz | awk '{len=split($1,arr,"_");print arr[len-3]}')
#echo before cat
#ls -al ${OUT}${PROJ}/${FC}/
cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L001_R1_* > ${OUT}${PROJ}/${FC}/1_${DATE}_${FC}_${var}_${BARCODE}_1.fastq.gz
cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L002_R1_* > ${OUT}${PROJ}/${FC}/2_${DATE}_${FC}_${var}_${BARCODE}_1.fastq.gz
cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L001_R2_* > ${OUT}${PROJ}/${FC}/1_${DATE}_${FC}_${var}_${BARCODE}_2.fastq.gz
cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L002_R2_* > ${OUT}${PROJ}/${FC}/2_${DATE}_${FC}_${var}_${BARCODE}_2.fastq.gz
#echo after cat
#ls -al ${OUT}${PROJ}/${FC}/
echo "[${NOW}] [${RUN}] cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L001_R1_* > ${OUT}${PROJ}/${FC}/1_${DATE}_${FC}_${var}_${BARCODE}_1.fastq.gz" >> ${PROJECTLOG}
echo "[${NOW}] [${RUN}] cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L002_R1_* > ${OUT}${PROJ}/${FC}/2_${DATE}_${FC}_${var}_${BARCODE}_1.fastq.gz" >> ${PROJECTLOG}
echo "[${NOW}] [${RUN}] cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L001_R2_* > ${OUT}${PROJ}/${FC}/1_${DATE}_${FC}_${var}_${BARCODE}_2.fastq.gz" >> ${PROJECTLOG}
echo "[${NOW}] [${RUN}] cat ${UNALIGNBASE}Unaligned/${PROJ}/${vars}/*_L002_R2_* > ${OUT}${PROJ}/${FC}/2_${DATE}_${FC}_${var}_${BARCODE}_2.fastq.gz" >> ${PROJECTLOG}
